...
int main(int argc, char ** argv)
{
	enum Color 
	{
		...
		quantity // размер энама по сути (у нас 6 цветов - 6)
	};
	...
	std::cout << "bitfield of unused colors: " << ~colors			<< std::endl; //инверсия тильдой
	...
	std::cout << "42 as binary long:     " << std::bitset < 32 > (42) << std::endl;//представили 42 в битовом виде
